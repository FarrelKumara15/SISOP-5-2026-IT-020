...
ROOTFS="${BUILD_DIR}/single_rootfs"
OUTPUT="${OUT_DIR}/single.gz"
...
echo "[+] Membuat struktur root filesystem single-user..."
...
do
    ...
    echo "======================================"
    echo " Farewell Party OS - Single User"
    echo "======================================"
    echo
    echo -n "login: "
    read USERNAME
...
echo "[+] Membuat initramfs single.gz..."
